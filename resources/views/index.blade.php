...
<section class="content-2 col-4" id="features1-21" style="background-color: rgb(255, 255, 255);">
    ...
    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{ asset ('new/assets/images/google-slides-350x350-16.png')}}"></div>
                    <div class="caption">
                        <div>
                        ...
                        <p class="group"><a href="https://mobirise.com/" class="btn btn-default">LEARN MORE</a></p>
                    </div>
                </div>
            </div>
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{ asset('new/assets/images/reminders-350x350-18.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>CONTACT FORMS</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/photos-350x350-95.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>IMAGE GALLERY</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/kindle-350x350-47.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>MOBILE MENU</h3>
                            <p>Sed egestas urna quam, sit amet euismod ligula commodo vitae. Cras hendrerit quam est, non dapibus turpis porta in. Fusce viverra, lectus vitae dignissim interdum, erat leo egestas velit, eu tincidunt tellus eros a mauris. </p>
...
<section class="content-2 col-4" id="features1-23" style="background-color: rgb(28, 73, 110);">
    ...
    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/maps-350x350-26.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>GOOGLE MAPS</h3>
                        ...
                        <p class="group"><a href="https://mobirise.com/" class="btn btn-info">LEARN MORE</a></p>
                    </div>
                </div>
            </div>
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/facebook-350x350-71.png')}}"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/bytafont-350x350-38.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>GOOGLE FONTS</h3>
                            <p>Duis sodales arcu eget gravida mollis. Sed condimentum nibh at dapibus semper. Etiam mattis leo at commodo eleifend. Integer mauris est, luctus vitae lobortis sed, tristique in eros. </p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/youtube-350x350-69.png')}}"></div>
                    <div class="caption">
                        <div>
        ...
        <div class="row">
            <div class="mbr-box mbr-box--fixed mbr-box--adapted">
                <div class="mbr-box__magnet mbr-box__magnet--top-right mbr-section__left col-sm-6">
                    <figure class="mbr-figure mbr-figure--adapted mbr-figure--caption-inside-bottom mbr-figure--full-width"><img class="mbr-figure__img" src="{{asset('new/assets/images/iphone-1067988-1920-1920x1440-18.jpg')}}"></figure>
                </div>
...
<section class="content-2 col-3" id="features1-26" style="background-color: rgb(239, 239, 239);">
    ...
    <div class="container">
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/phone-350x350-12.png')}}"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/anemone-350x350-67.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>EASY-TO-USE</h3>
                            <p>Sed vel vulputate lacus. Nulla et fringilla turpis. Etiam non urna magna. Fusce rutrum nec eros id dapibus. In tincidunt mi eget molestie condimentum.</p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/clear-350x350-99.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>FREE</h3>
                            <p>Sed vel vulputate lacus. Nulla et fringilla turpis. Etiam non urna magna. Fusce rutrum nec eros id dapibus. In tincidunt mi eget molestie condimentum.</p>
            ...
            <div class="row mbr-gallery-row no-gutter">
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    <a href="#lb-gallery1-28" data-slide-to="0" data-toggle="modal">
                        <img alt="" src="{{asset('new/assets/images/iphone-1067975-1920-1920x1439-11-1920x1439-53.jpg')}}">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    <a href="#lb-gallery1-28" data-slide-to="1" data-toggle="modal">
                        <img alt="" src="{{asset('new/assets/images/iphone-1067982-1920-1920x1439-68-1920x1439-47.jpg')}}">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    <a href="#lb-gallery1-28" data-slide-to="2" data-toggle="modal">
                        <img alt="" src="{{asset('new/assets/images/iphone-1067983-1920-1920x1440-44-1920x1440-62.jpg')}}">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div><div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 mbr-gallery-item">
                    <a href="#lb-gallery1-28" data-slide-to="3" data-toggle="modal">
                        <img alt="" src="{{asset('new/assets/images/iphone-1067991-1920-1920x1440-57-1920x1440-37.jpg')}}">
                        <span class="icon glyphicon glyphicon-zoom-in"></span>
                    </a>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="carousel-inner">
                        <div class="item">
                            <img alt="" src="{{asset('new/assets/images/iphone-1067975-1920-1920x1439-11.jpg')}}">
                        </div><div class="item">
                            <img alt="" src="{{asset('new/assets/images/iphone-1067982-1920-1920x1439-68.jpg')}}">
                        </div><div class="item">
                            <img alt="" src="{{asset('new/assets/images/iphone-1067983-1920-1920x1440-44.jpg')}}">
                        </div><div class="item active">
                            <img alt="" src="{{asset('new/assets/images/iphone-1067991-1920-1920x1440-57.jpg')}}">
                        </div>
                    </div>
...
<section class="msgbox-1" id="msg-box2-29" style="background-color: rgb(255, 255, 255);">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4"><a class="btn btn-lg btn-default" href="https://mobirise.com/">GET IT NOW</a></div>
        </div>
    </div>
</section>
...
<section class="content-2 col-4" id="features1-31" style="background-color: rgb(255, 255, 255);">
    ...
    <div class="container">
        ...
        <div class="row">
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/workflow-350x350-59.png')}}"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/chrome-remote-desktop-350x350-23.png')}}"></div>
                    <div class="caption">
                        <div>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/com-350x350-41.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>WEB FONTS</h3>
                            <p>Etiam lacinia volutpat magna, sed lobortis risus egestas in. Nunc fringilla urna ac libero venenatis molestie. Curabitur molestie mi quis mauris convallis aliquet. Cras pretium sapien mi, sed sagittis est ultrices at.</p>
            ...
            <div>
                <div class="thumbnail">
                    <div class="image"><img class="undefined" src="{{asset('new/assets/images/calculator-350x350-78.png')}}"></div>
                    <div class="caption">
                        <div>
                            <h3>PRICE TABLES</h3>
                            <p>Etiam lacinia volutpat magna, sed lobortis risus egestas in. Nunc fringilla urna ac libero venenatis molestie. Curabitur molestie mi quis mauris convallis aliquet. Cras pretium sapien mi, sed sagittis est ultrices at.</p>
